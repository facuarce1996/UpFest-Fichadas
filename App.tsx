...
export default function App() {
  ...
  if (!currentUser) return <LoginView onLogin={(u: User) => { setCurrentUser(u); setActiveTab(u.role === 'Admin' ? 'clock' : 'clock'); }} logoUrl={logoUrl} />;
